...
import io.github.palexdev.watchservice.AbstractWatchService.Event;
...
class AbstractWatchKey implements WatchKey {
  ...
  public AbstractWatchKey(
      ...
      Watchable watchable,
      Iterable<? extends Kind<?>> subscribedTypes,
      int queueSize) {
  ...
  public boolean subscribesTo(Kind<?> eventType) {
  ...
  final void signalEvent(Kind<Path> kind, Path context) {
